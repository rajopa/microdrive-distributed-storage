...
type LoginResponse struct {
	...
	RefreshToken  string                 `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` // <--- Добавили поле refresh_token
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_auth_proto_rawDesc = "" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB!Z\x1fmicrodrive_auth/pkg/proto;protob\x06proto3"
